...
class RegexPattern:
    ...
    def match(self, string):
        ...
        if self._match(string):
            return RegexMatch(self, string)
        else:
            return None
        """
        return ConcolicType("nil", False)
    ...
    # Overwrite area
    def __str__(self):
        return "{Pattern, pattern: %s)" % self.pattern




class RegexMatch():
    def __init__(self, pattern=None, string=None, flags=None):
        self.value = True
        self.expr = 'nil'
        self.string = string
        self.pattern = pattern

    def match(self, pattern=None, string=None, flags=None):
        return ConcolicType("nil", False)
    ...
    # Overwrite area
    def __str__(self):
        return "{Match, pattern: %s)" % self.pattern
